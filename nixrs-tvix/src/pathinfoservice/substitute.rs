...
use futures::Stream;
use nixrs::store::binary_cache::{BinaryStoreWrap, HttpBinaryCache};
use nixrs::store::{
...
impl Stores {
    async fn copy_digest(&mut self, digest: [u8; 20]) -> Result<bool, nixrs::store::Error> {

use super::{StatePrint, CollectionSize};
...
impl<'a, S, C, I, IntoIter> IntoIterator for MapPrintedColl<S, C>
    where C: IntoIterator<Item=&'a I, IntoIter = IntoIter>,
          S: StatePrint<I>,
          ...
          I: 'a,
{
    ...
    fn into_iter(self) -> Self::IntoIter {
        MapPrintedState { state: self.state, it: self.coll.into_iter() }
    }
}
